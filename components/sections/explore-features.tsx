  ...
  return (
    <section className="brand-section">
      <div className="container mx-auto px-4 py-12 sm:px-6 md:py-16">
        <div className="relative mx-auto max-w-6xl overflow-hidden rounded-3xl border border-border/60 px-6 py-10 text-white sm:px-8 md:px-10 md:py-12">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-neutral-950/85 via-neutral-950/80 to-neutral-950/90" aria-hidden="true" />
                  ...
                  >
                    <Link href={feature.href} className="block">
                      <div className="flex items-center gap-3">
                        <div className="inline-flex h-11 w-11 items-center justify-center rounded-xl border border-white/20 bg-white/10 backdrop-blur-sm transition-colors group-hover:bg-white/20">
                      ...
                      <p className="mt-3 max-w-[28ch] text-sm leading-relaxed text-slate-200">
                        {feature.description}
                      </p>
                    </Link>
                  </motion.div>
